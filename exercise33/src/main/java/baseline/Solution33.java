...
public class Solution33 {
    ...
    //create method that takes a list of strings and an index and prints the string at that index
    public static void printRandom(String[] list, int index) {
        //print the specific response
    }
